...
/**
 * Entry point of the 'Activity' generation module.
 *
 * @generated
 */
public class Activity extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/SWE_Android/files/activity";
     ...
     * @generated
     */
    public Activity(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Activity(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Activity generator = new Activity(modelURI, folder, arguments);
