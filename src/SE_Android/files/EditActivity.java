...
/**
 * Entry point of the 'EditActivity' generation module.
 *
 * @generated
 */
public class EditActivity extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/SE_Android/files/editActivity";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "editActivity" };
     ...
     * @generated
     */
    public EditActivity(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public EditActivity(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                EditActivity generator = new EditActivity(modelURI, folder, arguments);
