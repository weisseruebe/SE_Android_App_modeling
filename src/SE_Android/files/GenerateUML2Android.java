 ...
 * @generated
 */
public class GenerateUML2Android extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/SE_Android/files/uML2Android";
     ...
     * @generated
     */
    public GenerateUML2Android(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GenerateUML2Android(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateUML2Android generator = new GenerateUML2Android(modelURI, folder, arguments);
