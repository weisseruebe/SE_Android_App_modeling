...
/**
 * Entry point of the 'GridActivity' generation module.
 *
 * @generated
 */
public class GridActivity extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/SE_Android/files/GridActivity";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "GridActivity" };
     ...
     * @generated
     */
    public GridActivity(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GridActivity(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GridActivity generator = new GridActivity(modelURI, folder, arguments);
