...
/**
 * Entry point of the 'MapActivity' generation module.
 *
 * @generated
 */
public class MapActivity extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/SE_Android/files/mapActivity";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "mapActivity" };
     ...
     * @generated
     */
    public MapActivity(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public MapActivity(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                MapActivity generator = new MapActivity(modelURI, folder, arguments);
